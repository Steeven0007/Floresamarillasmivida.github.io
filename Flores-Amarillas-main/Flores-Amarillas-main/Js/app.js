const fechaEspecial = "04/08/2023";
const fechaElemento = document.getElementById("fecha-especial");

if (fechaElemento) {
    fechaElemento.textContent = `Nuestra fecha especial: ${fechaEspecial}`;
}
